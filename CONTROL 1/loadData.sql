...
-- Se añade el Rut_Empleado que agregaste en tu DDL
...
-- Sueldos recientes para la consulta de los "últimos 3 años"
...
(2, 2, '10:00:00', '12:00:00'), -- 2 horas (Cita larga)
(3, 3, '15:00:00', '15:30:00'); -- 30 min

-- Se incluye el Estado_Cita que agregaste en tu esquema
...
(4, 1, 1, 1, 1, 'Realizada', '2018-05-10'), -- Para consulta 6
(5, 2, 4, 3, 2, 'Realizada', '2029-08-20'), -- Para consulta 6
(6, 2, 2, 2, 1, 'Realizada', '2021-11-05'); -- Para consulta 9

-- Se adaptan las columnas Precio_Unitario y Subtotal según tu DDL
...
-- Se adaptan los nombres de columnas (Fecha_Pago, Monto_Total, Estado_pago)
